const en = {
  ...
  // left
  configConnectParams: 'Connection Settings',
  ...
  // menu
  configParams: 'Configuration Settings',
  scanList: 'Scan List',
  connectList: 'Connection List',
  ...
  openRssiChartAlert: 'This operation needs to start scanning, do you want to continue? (Please configure appropriate scan filtering parameters, only a maximum of 5 devices are supported for the time being, otherwise scanning will be automatically suspended)',
  alert: 'Alert',
